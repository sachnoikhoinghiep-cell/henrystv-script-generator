...
Yêu cầu: Kéo triết lý cổ đại về đời sống hiện đại, cụ thể là môi trường công sở, áp lực KPI, mưu sinh, quan hệ xã hội. Viết như đang nói chuyện thật, người nghe nhận ra bản thân trong đó.`;
  }
...
app.post('/api/youtube-hot-topics', async (req, res) => {
  ...
  const queries = [
    ...
    'nghệ thuật sống', 'đạo học', 'quỷ cốc tử', 'thiền định tâm lý'
  ];
...
const TOPIC_SUGGEST_SYSTEM = `Bạn là chuyên gia phân tích xu hướng nội dung YouTube tại Việt Nam, chuyên ngành "Ứng dụng Minh triết Cổ đông (Kinh Dịch, Phật giáo, Đạo học, Tam Quốc, Quỷ Cốc Tử) vào Quản trị Tâm lý và Nghệ thuật sống hiện đại".
...
3. Áp dụng được triết lý cổ đại (Tam Quốc, Kinh Dịch, Thiền sư, Đạo học...) vào tình huống hiện đại cụ thể
4. Tiêu đề nghe hấp dẫn, gây tò mò, có tiềm năng viral tại thị trường Việt Nam
5. Phù hợp video dài 10-20 phút, có chiều sâu triết lý
...
Quy tắc tiêu đề: [Uy danh Cổ nhân/Minh triết] + [Con số đóng gói/Câu hỏi gợi tò mò] + [Giải pháp nỗi đau] + [Từ ngữ cảm xúc cực hạn: Tuyệt đối, Đỉnh cao, Đừng bao giờ...].
